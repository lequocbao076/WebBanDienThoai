		...
		<div class="container">
			...
			<div class="row">
				...
				try {
					...
					String idsp = request.getParameter("madt");
					String sql = "SELECT * FROM sanpham WHERE MASP = " + "'" + idsp + "'";
				...
				<div class="col-md-5 col-md-push-2">
					<div id="product-main-img">
						<img src="./img/<%=rs.getString("HINHANH")%>" alt="">
					</div>
					<%
					}
					st.close();
